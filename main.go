...
import (
	...
	"github.com/smartcommunitylab/cloudasr-operator/controllers"
...
func init() {
	...
	utilruntime.Must(cloudasrv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "ab5c20ec.smartcommunitylab.it",
